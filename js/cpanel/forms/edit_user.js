				...
				items: [
					{
						...
						items: [
								...
								items : [
									{
										...
										listeners: {
											'change': function() {
												this.ownerCt.ownerCt.ownerCt.notifyPassChange.show();
											}
										}
									},
									{
							...
							},
							{
								...
								width: 400, value: 1, hidden: (FR.system.isFree || FR.userInfo.isGuest),
						...
						items: [
							{
								...
								helpText:
									FR.user.isIndep ?
										...
										FR.T('Type the path to a folder on your server. This is the user\'s personal working space.<br><br>Examples: 	c:/users/group_name<br>/home/users/group_name'),
							...
							},
							{
								...
								items: [
									...
									{xtype: 'button', text: FR.T('Check path'),
										cls:'fr-btn-default regular-case fr-btn-smaller fr-btn-nomargin',
										handler: function() {
											var fieldset = this.ownerCt.ownerCt.ownerCt;
											var par = 'path='+encodeURIComponent(fieldset.homefolder.getValue());
						...
						items: [
							{
								...
								items: [
									...
									{
										boxLabel: FR.T('User can zip and download folders'), value: 1, ref: 'downloadFolders',
		...
		'->',
		{
			...
			handler: function() {
				...
				this.deleteDlg = new Ext.Window({
					...
					footer: true, closable: false, layout: 'fit', bodyStyle: 'background-color:white;padding:10px 0 0 24px;',
					items: [
						{
