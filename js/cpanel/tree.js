	...
	var opts = {
		...
		uTools: {
			...
			children: [
				{
					text: FR.T('Web Links'),
					icon: FR.iconURL+'link.svg', leaf: true,
					id: 'wlinks',
					module: FR.modules.weblinks
				},
				{
					text: FR.T('Storage usage'), hidden: FR.system.isFree,
					icon: FR.iconURL+'pie-chart.svg', leaf: true, id: 'spacequota',
